...
public final class NavHeaderBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvHeaderRoom;

  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView tvHeaderName,
      @NonNull TextView tvHeaderRoom) {
    this.rootView = rootView;
    this.tvHeaderName = tvHeaderName;
    this.tvHeaderRoom = tvHeaderRoom;
  }
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvHeaderRoom;
      TextView tvHeaderRoom = ViewBindings.findChildViewById(rootView, id);
      if (tvHeaderRoom == null) {
        break missingId;
      }

      return new NavHeaderBinding((LinearLayout) rootView, tvHeaderName, tvHeaderRoom);
    }
